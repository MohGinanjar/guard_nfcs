package com.guard_nfcs.nfc_guard_patrol
...
private const val TAG = "NfcGuardPatrolPlugin"

/** NfcGuardPatrolPlugin */
class NfcGuardPatrolPlugin: FlutterPlugin, MethodCallHandler {
  ...
  override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
    channel = MethodChannel(flutterPluginBinding.binaryMessenger, "nfc_guard_patrol")
